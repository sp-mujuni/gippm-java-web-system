 ...
 * @author HP
 */
@WebServlet(name = "Likes_ghee", urlPatterns = {"/Likes_ghee"})

public class Likes_ghee extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<body>");
               ...
               out.println("The team behind our Ghee product thanks you for your like....To return, click");
