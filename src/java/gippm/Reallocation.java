...
//                 
                ...
                //Converting sales in the production lines from Strings to Int
               ...
               shortsales = parseInt(nshorts);
                ...
                newgroup=parseInt(totalString)-2;
                 ...
                 if(longsales>shortsales && longsales>midsales)
                 {
                     ...
                     checkdb.executeUpdate("update staff set allocation='"+3+"' where allocation='0'");
                     checkdb.executeUpdate("update production_lines set prdtn_size='"+1+"' where prdtn_line_id='2'");
                     checkdb.executeUpdate("update production_lines set prdtn_size='"+1+"' where prdtn_line_id='1'");
                 ...
                 else if(midsales>longsales && midsales > shortsales)
                 {
                     ...
                     checkdb.executeUpdate("update staff set allocation='"+2+"' where allocation='0'");
                     checkdb.executeUpdate("update production_lines set prdtn_size='"+1+"' where prdtn_line_id='3'");
                     checkdb.executeUpdate("update production_lines set prdtn_size='"+1+"' where prdtn_line_id='1'");
                 ...
                 {
                     checkdb.executeUpdate("update staff set allocation='"+1+"' where allocation='3'");
                     checkdb.executeUpdate("update staff set allocation='"+1+"' where allocation='0'");
                     checkdb.executeUpdate("update staff set allocation='"+1+"' where allocation='2'");
                     checkdb.executeUpdate("update production_lines set prdtn_size='"+1+"' where prdtn_line_id='3'");
                     checkdb.executeUpdate("update production_lines set prdtn_size='"+1+"' where prdtn_line_id='2'");
                     checkdb.executeUpdate("update production_lines set prdtn_size='"+newgroup+"' where prdtn_line_id='1'");
                 }
                 else
                 {
                     out.println("Error in reallocation! The reallocation is based on sales. So if sales made are zero, reallocation is impossible. ");
                 }
