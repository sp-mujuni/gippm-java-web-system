<%-- 
    Document   : admin
    Created on : Aug 8, 2022, 11:10:54 PM
    Author     : HP
--%>
            ...
            //3. If database connection is successful, we can now issue an SQL statement to verify the admin
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li><a href="pages/human_resource.jsp"><i class="fa fa-users orange_color"></i> <span>Human Resource</span></a></li>
                     
                     <li><a href="pages/products.jsp"><i class="fa fa-shopping-cart green_color"></i> <span>Products and Sales</span></a></li>
                     
                     <li><a href="pages/customers.jsp"><i class="fa fa-briefcase purple_color2"></i> <span>Customer base Tracking</span></a></li>

                     <li><a href="pages/reports.jsp"><i class="fa fa-file-text yellow_color"></i> <span>Reports</span></a></li>
               ...
               <div class="midde_cont">
                  <div class="container-fluid">
                     ...
                     <div class="row column1">
                        <div class="col-md-6 col-lg-3">
                           <a href="pages/human resource.jsp">
                           <div class="full counter_section margin_bottom_30">
                              ...
                              <div class="counter_no">
                                 <div>
                                    <p class="total_no"><%
                        staff=  checkdb.executeQuery("select count(staff_id) as num from staff");
                    while(staff.next()){
                        staff_total = staff.getString("num");
                        out.println(staff_total);
        }%></p>
                                    <p class="head_couter">Staff at company</p>
                                 </div>
                              </div>
                           </div>
                           </a>
                        ...
                        <div class="col-md-6 col-lg-3">
                           ...
                           <div class="full counter_section margin_bottom_30">
                              ...
                              <div class="counter_no">
                                 <div>
                                    <p class="total_no"><%
                        prod=  checkdb.executeQuery("select sum(stock) as quant from products");
                    while(prod.next()){
                       products = prod.getString("quant");
                        out.println(products);
        }%></p>
                                    <p class="head_couter">Stock level of products</p>
                                 </div>
                              </div>
                           </div>
                           </a>
                        ...
                        <div class="col-md-6 col-lg-3">
                           ...
                           <div class="full counter_section margin_bottom_30">
                              ...
                              <div class="counter_no">
                                 <div>
                                    <p class="total_no"><%
                        cust=  checkdb.executeQuery("select count(customer_id) as clients from customers");
                    while(cust.next()){
                        customers = cust.getString("clients");
                        out.println(customers);
        }%></p>
                                    <p class="head_couter">Registered Customers</p>
                                 </div>
                              </div>
                           </div>
                           </a>
                           ...
                           <div class="full counter_section margin_bottom_30">
                              ...
                              <div class="counter_no">
                                 <div>
                                    ...
                                    <p class="head_couter">Reports by default</p>
                                 </div>
                              </div>
                           </div>
                           </a>
                  ...
                  <div class="container-fluid">
                     <div class="footer">
                        ...
                        <p>Copyright &copy; 2022 BeezGroup<br></p>
                  </div>
               </div>
