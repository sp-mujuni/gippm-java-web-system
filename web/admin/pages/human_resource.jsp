               ...
               <div class="middle_cont">
                  <div class="container-fluid">
                     <div class="row column_title">
                        ...
                        shor=  checkdb.executeQuery("select * from production_lines where prdtn_line_id='1'");
                    while(shor.next()){
                        sh = shor.getString(3);
                        out.println(sh);
        }%></span></p>
                        ...
                        mid=  checkdb.executeQuery("select * from production_lines where prdtn_line_id='2'");
                    while(mid.next()){
                        md = mid.getString(3);
                        out.println(md);
        }%></span></p>
                        ...
                        lon=  checkdb.executeQuery("select * from production_lines where prdtn_line_id='3'");
                    while(lon.next()){
                        lo = lon.getString(3);
                        out.println(lo);
        }%></span></p>
                                          ...
                                          <div class="table_price full">
                                             <div class="inner_table_price">
                                                ...
                                                <div class="price_table_inner">
                                                   <div class="cont_table_price_blog">
                                                      <p class="red_color"><span class="price_no"><%
                        unassign=  checkdb.executeQuery("select * from production_lines where prdtn_line_id='0'");
                    while(unassign.next()){
                        none = unassign.getString(3);
                        out.println(none);
        }%></span></p>
                                                   </div>
                                       ...
                                       <div class="price_table_bottomm">
                                          <div class="center"><a class="main_bt" href="/Food Shelf/Reallocation">Reallocate staff</a></div>
