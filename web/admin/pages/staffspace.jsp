      ...
      <div class="full_container">
         <div class="inner_container">
            ...
            //3. If database connection is successful, we can now issue an SQL statement to verify the admin
                    ...
                    res=  checkdb.executeQuery("select * from staff where staff_id='gippm002'");
                    while(res.next()){
                    ...
                    total_staff=  checkdb.executeQuery("select count(staff_id) as stafftotal from staff where allocation='2'");
                    ...
                    daily=  checkdb.executeQuery("select sum(stock) as workload from products where productionline='2'");
