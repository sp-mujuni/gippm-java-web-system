      ...
      <div class="full_container">
         <div class="container">
            <div class="center verticle_center full_height">
               <div class="login_section">
                  <div class="logo_login">
                     <div class="center">
                        <img width="210" src="../admin/images/logo/logo.png" alt="#" /><span class="user-type"><b>Staff</b></span>
                     </div>
                  </div>
                   <%
            ...
            //3. If database connection is successful, we can now issue an SQL statement to verify the admin
                    ...
                    res=  checkdb.executeQuery("select * from staff");
                    while(res.next()){
                      id= res.getString(1);
                 ...
                 %>
                  <div class="login_form">
                     <form action="../admin/pages/staffspace.jsp">
                        <fieldset>
                           <div class="field">
