                ...
                <div class="bg-light p-30 mb-5">
                    <table>
                        <thead>
                            <tr>
                                <td><b>Date</b></td>
                                <td class="receipt-no"><b>Amount</b></td>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td><%
                                //date and time
                                date_t2 = checkdb.executeQuery("select * from orders where order_id='"+34+"'");
                                while(date_t2.next()){
                            ...
                            %></td>
                                <td class="receipt-no"><%
                                //getting order id
                                order2 = checkdb.executeQuery("select * from orders where order_id='"+34+"'");
                                while(order2.next()){
                            ...
                            <tr>
                                <td><%
                                //date and time
                                date_t3 = checkdb.executeQuery("select * from orders where order_id='"+35+"'");
                                while(date_t3.next()){
                            ...
                            %></td>
                                <td class="receipt-no"><%
                                //getting order id
                                order3 = checkdb.executeQuery("select * from orders where order_id='"+35+"'");
                                while(order3.next()){
                            ...
                            <tr>
                                <td><%
                                //date and time
                                date_t4 = checkdb.executeQuery("select * from orders where order_id='"+36+"'");
                                while(date_t4.next()){
                            ...
                            %></td>
                                <td class="receipt-no"><%
                                //getting order id
                                order4 = checkdb.executeQuery("select * from orders where order_id='"+36+"'");
                                while(order4.next()){
                            ...
                            <tr>
                                <td><%
                                //date and time
                                date_t4 = checkdb.executeQuery("select * from orders where order_id='"+37+"'");
                                while(date_t4.next()){
                                    dat4 = date_t4.getString("date");
                                    out.println(dat4);
                                } 
                            %></td>
                                <td class="receipt-no"><%
                                //getting order id
                                order4 = checkdb.executeQuery("select * from orders where order_id='"+37+"'");
                                while(order4.next()){
                                    or4 = order4.getString("total");
                                    out.println(or4);
                                } 
                            ...
                            <tr>
                                <td><%
                                //date and time
                                date_t4 = checkdb.executeQuery("select * from orders where order_id='"+38+"'");
                                while(date_t4.next()){
                                    dat4 = date_t4.getString("date");
                                    out.println(dat4);
                                } 
                            %></td>
                                <td class="receipt-no"><%
                                //getting order id
                                order4 = checkdb.executeQuery("select * from orders where order_id='"+38+"'");
                                while(order4.next()){
                                    or4 = order4.getString("total");
                                    out.println(or4);
                                } 
                    ...
                    while(user.next()){
                        ...
                        out.println(userdb);
                                }%>! We hope you had a nice experience. For any feedback or inquiry, reach out to us via our email: <a href="mailto:info.foodshelf@gmail.com">info.foodshelf@gmail.com</a></h5>
                            </div>
                        </div>
                    </div>
            </div>
